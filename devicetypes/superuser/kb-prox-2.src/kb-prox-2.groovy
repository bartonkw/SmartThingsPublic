metadata {
        definition (name: "KB Prox 2", author: "SmartThings") {
                capability "Actuator"
                capability "Switch"
                capability "Polling"
                capability "Refresh"
...
def parse(String description) {
        ...
        if (cmd) {
                ...
                log.debug "<KB>Parsed ${cmd} to ${result.inspect()}"
        } else {
